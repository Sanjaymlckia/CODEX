...
- Provides `S. Save / Backup State` in the selected-project menu. The aliases `update files`, `backup state`, `save state`, `heartbeat`, and `handoff` invoke the same manual action.
